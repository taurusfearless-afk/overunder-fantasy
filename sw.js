const CACHE='overunder-v48';
const CORE=['./','./index.html','./style.css','./premium-v3.css','./data.js','./script.js','./v33.js','./manifest.webmanifest','./assets/icon-192.png.png','./assets/icon-512.png.png','./assets/logo-main-transparent.png.png','./assets/logo-header-transparent.png.png','./assets/arena-bg.png.png'];
